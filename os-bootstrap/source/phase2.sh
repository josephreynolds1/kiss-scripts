...
### Validating phase1 app installation
  ...
  appValidation alsa-utils xorg-server xf86-input-libinput xauth xclip xset xrandr xssstate xinit hsetroot htop fontconfig liberation-fonts terminus-font imagemagick firefox dmenu dwm st slock sxiv bash pciutils usbutils vim
